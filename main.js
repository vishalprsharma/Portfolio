...
document.addEventListener("DOMContentLoaded", () => {
  ...
  subIcons.forEach((icon, idx) => showElement(icon, 400 + idx * 100));
  showElement(designerText, 600);

  // ⚡ Faster transition to main content
  setTimeout(() => {
    loadingScreen.style.opacity = "0"; // fade out the loader
    setTimeout(() => {
      loadingScreen.style.display = "none"; // hide loader after fade
    }, 500);
  }, 1800);
});
